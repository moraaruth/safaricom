            ...
            <div className='exprience'>
                ...
                <div className='container'>
                    ...
                    <div className='content'>
                        ...
                        <br /><br />
                        <img src='data-sharing-icon.386b4646.svg' alt='data sharing' />
                    ...
                    <div className='content'>
                        <img src='tunukiwa-offers-icon.85475bdf.svg' alt='tunukiwa' />
                        ...
                        <br />
                        <img src='discover-more-icon.b13469aa.svg' alt='discover more'/>
